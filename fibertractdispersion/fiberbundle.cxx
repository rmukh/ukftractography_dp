...
void fiberbundle ::ReadFibers(std::string inputFibersFileName)
{
...
void fiberbundle ::WriteFibers(std::string outputFibersFileName, bool writeAscii, bool writeUnCompressed)
{
